...
public class MavenPlugin implements IXMLExtension {
	...
	public static final File LOCAL_REPOSITORY = System.getProperty("maven.repo.local") != null ? new File(System.getProperty("maven.repo.local")) : RepositorySystem.defaultUserLocalRepository;
